...
int do_random_walk(struct created_cell_t *created, 
                   const struct create_cell_t *create);
int random_walk_process_created_cell(origin_circuit_t *circ, 
                                     struct created_cell_t *cc);
